...
function SectionIntro({ eyebrow, title, subtitle, className = "", align = "center" }) {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        eyebrow && /* @__PURE__ */ jsx("div", { className: "eyebrow text-teal mb-4", children: eyebrow }),
        /* @__PURE__ */ jsx("h2", { style: { fontSize: "clamp(28px, 4vw, 44px)", marginBottom: subtitle ? 16 : 0, lineHeight: 1.15 }, children: title }),
