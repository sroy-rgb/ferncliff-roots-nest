...
function GalleryPage() {
  ...
  return /* @__PURE__ */ jsxs(CampLayout, { children: [
    /* @__PURE__ */ jsx(CampHero, { image: "https://images.pexels.com/photos/2526040/pexels-photo-2526040.jpeg?auto=compress&cs=tinysrgb&w=1920", eyebrow: "Gallery", title: /* @__PURE__ */ jsxs(Fragment, { children: [
      "See Ferncliff through our campers' ",
      /* @__PURE__ */ jsx(HeroEm, { children: "eyes" })
    ] }), subtitle: "A look at the lakes, cabins, faces, and moments that make a week here.", height: "50vh" }),
    /* @__PURE__ */ jsx("section", { className: "pt-[80px] pb-4 bg-offwhite", children: /* @__PURE__ */ jsx("div", { className: "max-w-[1200px] mx-auto px-8", children: /* @__PURE__ */ jsx(SectionIntro, { eyebrow: "Gallery", title: /* @__PURE__ */ jsxs(Fragment, { children: [
      "See Ferncliff through our campers' ",
      /* @__PURE__ */ jsx(Hw, { children: "eyes" })
    ] }) }) }) }),
    /* @__PURE__ */ jsx("section", { className: "py-[60px] md:py-[80px] bg-offwhite", children: /* @__PURE__ */ jsx("div", { className: "max-w-[1300px] mx-auto px-6", children: /* @__PURE__ */ jsx("div", { className: "grid gap-4", style: {
      gridTemplateColumns: "repeat(auto-fill, minmax(min(100%, 280px), 1fr))",
      gridAutoRows: "200px"
    }, children: images.map((img, i) => /* @__PURE__ */ jsxs("button", { onClick: () => setOpenIdx(i), className: "relative rounded-[16px] overflow-hidden group cursor-pointer", style: {
      gridRow: img.span ? "span 2" : void 0
    }, children: [
      /* @__PURE__ */ jsx("img", { src: img.src, alt: "", className: "w-full h-full object-cover transition-transform duration-500 group-hover:scale-[1.03]" }),
      /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-black/0 group-hover:bg-black/40 transition flex items-center justify-center opacity-0 group-hover:opacity-100", children: /* @__PURE__ */ jsx("span", { className: "w-12 h-12 rounded-full bg-white/95 flex items-center justify-center", children: /* @__PURE__ */ jsx(Eye, { size: 20, weight: "regular", className: "text-teal" }) }) })
    ] }, i)) }) }) }),
    openIdx !== null && /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-[2000] flex items-center justify-center animate-fade-in", style: {
      ...
      }, onMouseEnter: (e) => e.currentTarget.style.background = "rgba(255,255,255,0.1)", onMouseLeave: (e) => e.currentTarget.style.background = "rgba(255,255,255,0)", "aria-label": "Close", children: /* @__PURE__ */ jsx(X, { size: 24, weight: "bold" }) }),
      /* @__PURE__ */ jsx("button", { onClick: (e) => {
        e.stopPropagation();
        navigate(-1);
      }, className: "absolute left-5 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full flex items-center justify-center text-white transition", onMouseEnter: (e) => e.currentTarget.style.background = "rgba(255,255,255,0.1)", onMouseLeave: (e) => e.currentTarget.style.background = "rgba(255,255,255,0)", "aria-label": "Previous", children: /* @__PURE__ */ jsx(ArrowLeft, { size: 24, weight: "bold" }) }),
      /* @__PURE__ */ jsx("img", { src: images[openIdx].src, alt: "", onClick: (e) => e.stopPropagation(), className: "rounded-[12px] transition-opacity duration-300", style: {
        maxHeight: "85vh",
        maxWidth: "90vw",
        objectFit: "contain",
        opacity: fade ? 1 : 0,
      ...
      /* @__PURE__ */ jsx("button", { onClick: (e) => {
        e.stopPropagation();
        navigate(1);
      }, className: "absolute right-5 top-1/2 -translate-y-1/2 w-12 h-12 rounded-full flex items-center justify-center text-white transition", onMouseEnter: (e) => e.currentTarget.style.background = "rgba(255,255,255,0.1)", onMouseLeave: (e) => e.currentTarget.style.background = "rgba(255,255,255,0)", "aria-label": "Next", children: /* @__PURE__ */ jsx(ArrowRight, { size: 24, weight: "bold" }) }),
      /* @__PURE__ */ jsxs("div", { className: "absolute bottom-6 left-0 right-0 text-center text-white/70 text-[14px]", children: [
        openIdx + 1,
        " / ",
        images.length
      ] }),
      /* @__PURE__ */ jsx("style", { children: `@keyframes scaleIn { from { transform: scale(0.9); opacity: 0; } to { transform: scale(1); opacity: 1; } }` })
    ] })
  ] });
}
export {
