...
function AnchorSubNav({ links }) {
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx("div", { className: "max-w-[1400px] mx-auto px-6 md:px-10 overflow-x-auto", children: /* @__PURE__ */ jsx("div", { className: "flex items-center gap-1 h-[48px] whitespace-nowrap", children: links.map((l) => {
