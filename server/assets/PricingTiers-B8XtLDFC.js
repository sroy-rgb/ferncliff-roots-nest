...
function PricingTiers({ tiers, labels = ["Tier 1", "Tier 2", "Tier 3"] }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 gap-3 my-4", children: tiers.map((price, i) => {
    const featured = i === 0;
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "font-serif text-[24px] leading-none my-1", children: price }),
          /* @__PURE__ */ jsx(
            "div",
            {
