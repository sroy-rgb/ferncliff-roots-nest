...
const appCss = "/assets/styles-C9EBASvw.css";
...
function AdminAuthProvider({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Ctx.Provider, { value: { loggedIn, login, logout }, children });
}
...
const a$1 = /* @__PURE__ */ new Map([
  [
    "bold",
    /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, /* @__PURE__ */ reactExports.createElement("path", { d: "M228,128a12,12,0,0,1-12,12H69l51.52,51.51a12,12,0,0,1-17,17l-72-72a12,12,0,0,1,0-17l72-72a12,12,0,0,1,17,17L69,116H216A12,12,0,0,1,228,128Z" }))
  ],
  [
    "duotone",
    /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, /* @__PURE__ */ reactExports.createElement("path", { d: "M112,56V200L40,128Z", opacity: "0.2" }), /* @__PURE__ */ reactExports.createElement("path", { d: "M216,120H120V56a8,8,0,0,0-13.66-5.66l-72,72a8,8,0,0,0,0,11.32l72,72A8,8,0,0,0,120,200V136h96a8,8,0,0,0,0-16ZM104,180.69,51.31,128,104,75.31Z" }))
  ],
  [
    "fill",
    /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, /* @__PURE__ */ reactExports.createElement("path", { d: "M224,128a8,8,0,0,1-8,8H120v64a8,8,0,0,1-13.66,5.66l-72-72a8,8,0,0,1,0-11.32l72-72A8,8,0,0,1,120,56v64h96A8,8,0,0,1,224,128Z" }))
  ],
  [
    "light",
    /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, /* @__PURE__ */ reactExports.createElement("path", { d: "M222,128a6,6,0,0,1-6,6H54.49l61.75,61.76a6,6,0,1,1-8.48,8.48l-72-72a6,6,0,0,1,0-8.48l72-72a6,6,0,0,1,8.48,8.48L54.49,122H216A6,6,0,0,1,222,128Z" }))
  ],
  [
    "regular",
    /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, /* @__PURE__ */ reactExports.createElement("path", { d: "M224,128a8,8,0,0,1-8,8H59.31l58.35,58.34a8,8,0,0,1-11.32,11.32l-72-72a8,8,0,0,1,0-11.32l72-72a8,8,0,0,1,11.32,11.32L59.31,120H216A8,8,0,0,1,224,128Z" }))
  ],
  [
    "thin",
    /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, /* @__PURE__ */ reactExports.createElement("path", { d: "M220,128a4,4,0,0,1-4,4H49.66l65.17,65.17a4,4,0,0,1-5.66,5.66l-72-72a4,4,0,0,1,0-5.66l72-72a4,4,0,0,1,5.66,5.66L49.66,124H216A4,4,0,0,1,220,128Z" }))
  ]
]);
...
const o$2 = reactExports.createContext({
  color: "currentColor",
  size: "1em",
  weight: "regular",
  mirrored: false
...
const r = reactExports.forwardRef((e2, t) => /* @__PURE__ */ reactExports.createElement(p, { ref: t, ...e2, weights: a$1 }));
r.displayName = "ArrowLeftIcon";
const s = r;
const o$1 = reactExports.forwardRef((r2, a2) => /* @__PURE__ */ reactExports.createElement(p, { ref: a2, ...r2, weights: l }));
o$1.displayName = "GearIcon";
const n = o$1;
const o = reactExports.forwardRef((i, m) => /* @__PURE__ */ reactExports.createElement(p, { ref: m, ...i, weights: e }));
...
function AdminToggle() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Link,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(n, { size: 14, weight: "regular" }),
        " Admin"
      ]
    }
  );
...
const ContentCtx = reactExports.createContext(null);
...
function ContentStoreProvider({ children }) {
  ...
  const pushActivity = reactExports.useCallback((text, dot = "#2B7A6F") => {
    setState((s2) => ({
      ...s2,
      activity: [
  ...
  const updateHomepage = reactExports.useCallback((patch) => {
    setState((s2) => ({ ...s2, homepage: { ...s2.homepage, ...patch } }));
  }, []);
  const updatePage = reactExports.useCallback((id, patch) => {
    setState((s2) => {
      const next = s2.pages.map((p2) => p2.id === id ? { ...p2, ...patch, modified: "Just now" } : p2);
      const updated = next.find((p2) => p2.id === id);
      if (updated) {
        setState((s22) => ({
          ...s22,
          activity: [
      ...
      return { ...s2, pages: next };
    });
  }, []);
  const addPage = reactExports.useCallback((p2) => {
    setState((s2) => {
      const id = `page-${Date.now()}`;
      const entry = { ...p2, id, modified: "Just now" };
      return {
        ...s2,
        pages: [...s2.pages, entry],
        activity: [{ id: ++nextActivityId, text: `Page created — ${p2.title}`, dot: "#2B7A6F", time: "Just now", ts: Date.now() }, ...s2.activity]
      };
    });
  }, []);
  const deletePage = reactExports.useCallback((id) => {
    setState((s2) => {
      const page = s2.pages.find((p2) => p2.id === id);
      return {
        ...s2,
        pages: s2.pages.filter((p2) => p2.id !== id && p2.parent !== id),
        activity: page ? [{ id: ++nextActivityId, text: `Page deleted — ${page.title}`, dot: "#2B7A6F", time: "Just now", ts: Date.now() }, ...s2.activity] : s2.activity
      };
    });
  }, []);
  const setBlogStatus = reactExports.useCallback((id, status) => {
    setState((s2) => {
      const next = s2.blogPosts.map((b) => b.id === id ? { ...b, status } : b);
      const post = next.find((b) => b.id === id);
      return {
        ...s2,
        blogPosts: next,
        activity: post ? [{ id: ++nextActivityId, text: `Blog post ${status === "Published" ? "published" : "drafted"} — ${post.title}`, dot: "#C49A3C", time: "Just now", ts: Date.now() }, ...s2.activity] : s2.activity
      };
    });
  }, []);
  const addBlogPost = reactExports.useCallback((b) => {
    setState((s2) => {
      ...
      return {
        ...s2,
        blogPosts: [post, ...s2.blogPosts],
        activity: [{ id: ++nextActivityId, text: `Blog post created — ${b.title}`, dot: "#C49A3C", time: "Just now", ts: Date.now() }, ...s2.activity]
      };
    });
  }, []);
  const updateBlogPost = reactExports.useCallback((id, patch) => {
    setState((s2) => ({
      ...s2,
      blogPosts: s2.blogPosts.map((b) => b.id === id ? { ...b, ...patch } : b),
      activity: [{ id: ++nextActivityId, text: `Blog post updated — ${patch.title ?? s2.blogPosts.find((b) => b.id === id)?.title ?? ""}`, dot: "#C49A3C", time: "Just now", ts: Date.now() }, ...s2.activity]
    }));
  }, []);
  const deleteBlogPost = reactExports.useCallback((id) => {
    setState((s2) => {
      const post = s2.blogPosts.find((b) => b.id === id);
      return {
        ...s2,
        blogPosts: s2.blogPosts.filter((b) => b.id !== id),
        activity: post ? [{ id: ++nextActivityId, text: `Blog post deleted — ${post.title}`, dot: "#C49A3C", time: "Just now", ts: Date.now() }, ...s2.activity] : s2.activity
      };
    });
  }, []);
  const addBooking = reactExports.useCallback((b) => {
    setState((s2) => {
      const booking = { ...b, id: ++nextInquiryId, createdISO: (/* @__PURE__ */ new Date()).toISOString() };
      return {
        ...s2,
        bookings: [booking, ...s2.bookings],
        activity: [{ id: ++nextActivityId, text: `Booking added — ${b.org} · ${b.dates}`, dot: "#2B7A6F", time: "Just now", ts: Date.now() }, ...s2.activity]
      };
    });
  }, []);
  const setBookingStatus = reactExports.useCallback((id, status) => {
    setState((s2) => ({
      ...s2,
      bookings: s2.bookings.map((b) => b.id === id ? { ...b, status } : b)
    }));
  }, []);
  const addInquiry = reactExports.useCallback((i) => {
    setState((s2) => {
      const inquiry = { ...i, id: ++nextInquiryId, status: "new", received: "Just now" };
      return {
        ...s2,
        inquiries: [inquiry, ...s2.inquiries],
        activity: [
  ...
  const setInquiryStatus = reactExports.useCallback((id, status) => {
    setState((s2) => {
      const next = s2.inquiries.map((i) => i.id === id ? { ...i, status } : i);
      const inq = next.find((i) => i.id === id);
      return {
        ...s2,
        inquiries: next,
        activity: inq ? [{ id: ++nextActivityId, text: `Inquiry ${status} — ${inq.org}`, dot: "#2B7A6F", time: "Just now", ts: Date.now() }, ...s2.activity] : s2.activity
      };
    });
  }, []);
  const fmtTime = (d) => d.toLocaleString("en-US", { month: "short", day: "numeric", hour: "numeric", minute: "2-digit" });
  const addRegistration = reactExports.useCallback((r2) => {
    setState((s2) => {
      const now = /* @__PURE__ */ new Date();
      const reg = { ...r2, id: ++nextInquiryId, status: "new", receivedISO: now.toISOString(), received: fmtTime(now) };
      return {
        ...s2,
        registrations: [reg, ...s2.registrations],
        activity: [
          { id: ++nextActivityId, text: `New camp registration — ${r2.camperName} · ${r2.session}`, dot: "#2B7A6F", time: "Just now", ts: Date.now() },
          ...s2.activity
        ]
      };
    });
  }, []);
  const setRegistrationStatus = reactExports.useCallback((id, status) => {
    setState((s2) => {
      const next = s2.registrations.map((r2) => r2.id === id ? { ...r2, status } : r2);
      const reg = next.find((r2) => r2.id === id);
      return {
        ...s2,
        registrations: next,
        activity: reg ? [{ id: ++nextActivityId, text: `Registration ${status} — ${reg.camperName}`, dot: "#2B7A6F", time: "Just now", ts: Date.now() }, ...s2.activity] : s2.activity
      };
    });
  }, []);
  const addVolunteerRequest = reactExports.useCallback((v) => {
    setState((s2) => {
      const now = /* @__PURE__ */ new Date();
      const vol = { ...v, id: ++nextInquiryId, status: "new", receivedISO: now.toISOString(), received: fmtTime(now) };
      return {
        ...s2,
        volunteerRequests: [vol, ...s2.volunteerRequests],
        activity: [
  ...
  const setVolunteerStatus = reactExports.useCallback((id, status) => {
    setState((s2) => {
      const next = s2.volunteerRequests.map((v) => v.id === id ? { ...v, status } : v);
      const vol = next.find((v) => v.id === id);
      return {
        ...s2,
        volunteerRequests: next,
        activity: vol ? [{ id: ++nextActivityId, text: `Volunteer ${status} — ${vol.name}`, dot: "#C49A3C", time: "Just now", ts: Date.now() }, ...s2.activity] : s2.activity
      };
    });
  }, []);
  const addEnrollment = reactExports.useCallback((e2) => {
    setState((s2) => {
      const now = /* @__PURE__ */ new Date();
      const enr = { ...e2, id: ++nextInquiryId, status: "new", receivedISO: now.toISOString(), received: fmtTime(now) };
      return {
        ...s2,
        enrollments: [enr, ...s2.enrollments],
        activity: [
          { id: ++nextActivityId, text: `New enrollment — ${e2.childName} · ${e2.program}`, dot: "#2B7A6F", time: "Just now", ts: Date.now() },
          ...s2.activity
        ]
      };
    });
  }, []);
  const setEnrollmentStatus = reactExports.useCallback((id, status) => {
    setState((s2) => {
      const next = s2.enrollments.map((e2) => e2.id === id ? { ...e2, status } : e2);
      const enr = next.find((e2) => e2.id === id);
      return {
        ...s2,
        enrollments: next,
        activity: enr ? [{ id: ++nextActivityId, text: `Enrollment ${status} — ${enr.childName}`, dot: "#2B7A6F", time: "Just now", ts: Date.now() }, ...s2.activity] : s2.activity
      };
    });
  }, []);
  const addGeneralInquiry = reactExports.useCallback((g) => {
    setState((s2) => {
      const now = /* @__PURE__ */ new Date();
      const gi = { ...g, id: ++nextInquiryId, status: "pending", receivedISO: now.toISOString(), received: fmtTime(now) };
      return {
        ...s2,
        generalInquiries: [gi, ...s2.generalInquiries],
        activity: [
  ...
  const setGeneralInquiryStatus = reactExports.useCallback((id, status) => {
    setState((s2) => ({
      ...s2,
      generalInquiries: s2.generalInquiries.map((g) => g.id === id ? { ...g, status } : g)
    }));
  }, []);
  const addDonation = reactExports.useCallback((d) => {
    setState((s2) => {
      const now = /* @__PURE__ */ new Date();
      ...
      return {
        ...s2,
        donations: [don, ...s2.donations],
        homepage: { ...s2.homepage, campaignRaised: s2.homepage.campaignRaised + d.amount },
        activity: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ContentCtx.Provider, { value: {
    ...state,
    updateHomepage,
    updatePage,
    addPage,
...
function useContentStore() {
  const v = reactExports.useContext(ContentCtx);
...
function AdminViewingBar() {
  ...
  const match = pages.find((p2) => p2.slug === path);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "You're viewing the live site. Content changes made in the admin panel are reflected here." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "sm:hidden", children: "Live preview · admin session" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto flex items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: editTarget, className: "inline-flex items-center gap-1 text-[#2B7A6F] hover:underline", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(a, { size: 12 }),
            " Edit This Page"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/admin", className: "inline-flex items-center gap-1 text-[#2c2926] hover:text-[#2B7A6F]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(s, { size: 12 }),
            " Back to Admin"
          ] })
        ] })
      ]
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AdminAuthProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ContentStoreProvider, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AdminViewingBar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AdminToggle, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {})
  ] }) }) });
}
const $$splitComponentImporter$B = () => import("./retreats-KMS6xrPm.js");
...
const $$splitComponentImporter$A = () => import("./outreach-DrSJHWKA.js");
...
const $$splitComponentImporter$z = () => import("./nature-school-BwXz4fPZ.js");
...
const $$splitComponentImporter$y = () => import("./giving-BHnOl0y4.js");
...
const $$splitComponentImporter$x = () => import("./about-DJrMwsDY.js");
...
const $$splitComponentImporter$w = () => import("./index-BG5--6I3.js");
const Route$w = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$w, "component")
});
const $$splitComponentImporter$v = () => import("./index-C_aYuef2.js");
...
const $$splitComponentImporter$u = () => import("./index-jJIC9L4a.js");
...
const $$splitComponentImporter$t = () => import("./index-DQDHZ1fA.js");
...
const $$splitComponentImporter$s = () => import("./rebecca-spooner-DZd4JCee.js");
...
const $$splitComponentImporter$r = () => import("./emelia-lee-8M6771sE.js");
...
const $$splitComponentImporter$q = () => import("./anyone-can-make-a-difference-DyCNdiWp.js");
...
const $$splitComponentImporter$p = () => import("./specialty-DBqboead.js");
...
const $$splitComponentImporter$o = () => import("./register-CrK3IUXk.js");
...
const $$splitComponentImporter$n = () => import("./overnight-C6e1G9z3.js");
...
const $$splitComponentImporter$m = () => import("./gallery-DFGEr7CH.js");
...
const $$splitComponentImporter$l = () => import("./first-time-52qUX8ZU.js");
...
const $$splitComponentImporter$k = () => import("./family-A2uhmW8A.js");
...
const $$splitComponentImporter$j = () => import("./discovery-FYNyKX-B.js");
...
const $$splitComponentImporter$i = () => import("./day-7m1EhbpC.js");
...
const $$splitComponentImporter$h = () => import("./dates-D7AWqHHc.js");
...
const $$splitComponentImporter$g = () => import("./volunteers-BE461iDA.js");
...
const $$splitComponentImporter$f = () => import("./users-Doq-GAI3.js");
...
const $$splitComponentImporter$e = () => import("./subscribers-2FULwx9P.js");
...
const $$splitComponentImporter$d = () => import("./settings-DYEinm4G.js");
...
const $$splitComponentImporter$c = () => import("./seo-BF1eqrok.js");
...
const $$splitComponentImporter$b = () => import("./roadmap-BO8QRWx3.js");
...
const $$splitComponentImporter$a = () => import("./retreats-BnEJguXP.js");
...
const $$splitComponentImporter$9 = () => import("./registrations-Bd67SF_f.js");
...
const $$splitComponentImporter$8 = () => import("./pages-CCQVBKaq.js");
...
const $$splitComponentImporter$7 = () => import("./outreach-DchWg6Vb.js");
...
const $$splitComponentImporter$6 = () => import("./nature-BMRgFd68.js");
...
const $$splitComponentImporter$5 = () => import("./media-Crocnk-z.js");
...
const $$splitComponentImporter$4 = () => import("./login-DyIUcE3F.js");
...
const $$splitComponentImporter$3 = () => import("./inquiries-gUbt5NwQ.js");
...
const $$splitComponentImporter$2 = () => import("./giving-ZHt5i19n.js");
...
const $$splitComponentImporter$1 = () => import("./camp-BC9Obw_-.js");
...
const $$splitComponentImporter = () => import("./blog-C3XQ0-1N.js");
